...
#SBATCH --output=/vast/palmer/scratch/ohern/as4643/hydro_results/patches/out_files/9.out
#SBATCH --requeue
##SBATCH --array=1-2
...
python -m hydrophobicity.compare_chains /vast/palmer/scratch/ohern/as4643/Decoys/Supersampled_structures/groups/9/
